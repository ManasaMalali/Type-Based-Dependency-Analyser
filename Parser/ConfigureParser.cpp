...
void ConfigParseForCodeAnal::BuildTemp()
{
...
Parser* ConfigParseForCodeAnal::Build()
{
  try{
    ...
    pRepo = new Repository(pToker);pBeginScope = new BeginScope();
    ...
    pParser->addRule(pEndScope);pPreprocStatement = new PreprocStatement;
